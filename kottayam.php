...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4"><h1><i>KOTTAYAM</i></h1></div>
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4"></div>
        </div>
        <div class="row">
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
              <div class="card" style="width: 18rem;">
                <img src="imagekollam\1091.jpg" class="card-img-top" alt="..." height="200" weight="100">
                <div class="card-body">
                  <p class="card-text">A paradise for bird watchers, Kumarakom Bird Sanctuary or Vembanad Bird Sanctuary is situated on the banks of Lake Vembanad in kavanar River basin. The place is spread across a huge area of 14 acres providing a natural habitat to about 91 species of local birds and 50 species of migratory birds.</p>
                </div>
              </div>
                </div>
                <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                  <div class="card" style="width: 18rem;">
                    <img src="imagekollam\6215.jpg" class="card-img-top" alt="..." height="200" weight="100">
                    <div class="card-body">
                      <p class="card-text">After all the blessings from temples, it is time for some adventure. Nadukani is one such place nestled amid the wilderness of nature and densely wooded hills offering its visitors a beautiful trail for trekking..</p>
                    </div>
                  </div>
                    </div>
                    <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                      <div class="card" style="width: 18rem;">
                        <img src="imagekollam\5978.jpg" class="card-img-top" alt="..." height="200" weight="100">
                        <div class="card-body">
                          <p class="card-text">A fascinating cave carved out of rock surface is Kottathavalam lying on the top of a Murugan Hills at Kurisumala. The cave is considered to be the resting place for Madura Royal family..</p>
                        </div>
                      </div>
                        </div>
               </div>
