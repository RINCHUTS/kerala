...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4"><h1><i>WAYANAD</i></h1></div>
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4"></div>
        </div>
        <div class="row">
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
              <div class="card" style="width: 18rem;">
                <img src="imagekollam\shutterstock_796295632_20200116122849_20200116122911.png" class="card-img-top" alt="..." height="200" weight="100">
                <div class="card-body">
                  <p class="card-text">Famous for its exquisite rock and wall carvings, this pre-historic Edakkal Caves measures 96 ft long and 22 ft wide. You need to trek for one and half hour to hit the cave entrance, and another 45 minutes to reach the mouth of the cave. Boating cost: Pedal boat (Rs 30/2 people, Rs 50/4 people), Row boat (Rs 50/4 people) and Kayaking (Rs 100/30 minutes)</p>
                </div>
              </div>
                </div>
                <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                  <div class="card" style="width: 18rem;">
                    <img src="imagekollam\966_20200529095124.jpg" class="card-img-top" alt="..." height="200" weight="100">
                    <div class="card-body">
                      <p class="card-text">Wayanad Wildlife Sanctuary is the second largest wildlife sanctuary in Kerala and comprises of rare as well as endangered species of both flora and fauna. It is surrounded by the protected areas of Mudumalai in Tamil Nadu as well as Nagarhole and Bandipur in Karnataka..</p>
                    </div>
                  </div>
                    </div>
                    <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                      <div class="card" style="width: 18rem;">
                        <img src="imagekollam\shutterstock_1140378593_20200116122458_20200116122531.png" class="card-img-top" alt="..." height="200" weight="100">
                        <div class="card-body">
                          <p class="card-text">Lying in the lap of the Banasura hills in the Wayanad district is the picturesque Banasura Sagar dam. Banasura Dam is the largest earthen dam in the country and the second-largest in Asia. The view of the sprawling reservoir from the top of the dam is breathtaking. Adventures like speed boating are readily available, and a trek up to the Banasura Peak is filled with streams, diverse flora, fauna, lush tropical green and majestic waterfalls.</p>
                        </div>
                      </div>
                        </div>
               </div>
